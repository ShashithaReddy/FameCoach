  ...
  return (
    <View style={styles.page12}>
      <View style={[styles.page8, styles.page8Position]}>
        ...
        <View style={[styles.chatBubbleSittiUp, styles.chatPosition1]}>
        ...
        <View style={[styles.chatBubbleSittiUp3, styles.chatLayout]}>
          <Text
            style={[styles.message1, styles.messageTypo]}
          >{`It's Raining Men — May 3, 2024
Shooting Stars — May 3, 2024
It's About Time — May 3, 2024
Jocelyn's Dance — April 26, 2024
If You Love Me — April 26, 2024
Donk — April 19, 2024
Glitching Woes — April 19, 2024`}</Text>
        </View>
