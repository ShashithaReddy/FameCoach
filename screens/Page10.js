  ...
  return (
    <View style={styles.page10}>
      <View style={[styles.page8, styles.page8Position]}>
        ...
        <View style={[styles.chatBubbleSittiUp, styles.chatSpaceBlock]}>
        ...
        <View style={[styles.chatBubbleSittiUp1, styles.chatSpaceBlock]}>
        ...
        <View
          style={[styles.animation300Kg5ef0sf1Wrapper, styles.chatSpaceBlock]}
        >
          <Image
